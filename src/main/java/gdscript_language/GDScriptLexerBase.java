...
abstract class GDScriptLexerBase extends Lexer {
    ...
    public Token nextToken() {
        ...
        if (_input.LA(1) == EOF && !this.indents.isEmpty()) {
            ...
            this.emit(commonToken(GDScriptLexer.NEWLINE, "\n"));
            ...
            this.emit(commonToken(GDScriptLexer.EOF, "<EOF>"));
        }
    ...
    private Token createDedent() {
        CommonToken dedent = commonToken(GDScriptLexer.DEDENT, "");
    ...
    void onNewLine(){
        ...
        if (opened > 0 || (nextnext != -1 && (next == '\r' || next == '\n' || next == '\f' || next == '#'))) {
            ...
            if (indent == previous) {
                ...
                indents.push(indent);
                emit(commonToken(GDScriptLexer.INDENT, spaces));
            }
            else {
